    ...
    if (legacyBadges && !document.querySelector('.hero__trust')) {
      ...
      trust.innerHTML =
        '<div class="hero__trust-item badge">' +
          ...
          '<span><strong>$5M &amp; WSIB</strong><small>Insurance coverage</small></span>' +
        '</div>' +
        '<div class="hero__trust-item badge">' +
          ...
          '<span><strong>Licensed trades</strong><small>Plumbing / electrical / HVAC</small></span>' +
        '</div>' +
        '<div class="hero__trust-item badge">' +
        ...
        '<div class="hero__trust-item badge">' +
          ...
          '<span><strong>5.0</strong><small>Google Reviews · Trusted by homeowners</small></span>' +
        '</div>';
